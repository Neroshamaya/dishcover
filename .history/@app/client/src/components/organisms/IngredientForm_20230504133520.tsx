...
import { CreateIngredientFormSchemaType } from '@dishcover/shared'

CreateIngredientFormSchemaType
interface IngredientFormProps {
  onSubmit: () => void
  create: boolean
}

export default function IngredientForm({ onSubmit: postSubmit, create }: IngredientFormProps) {
  const {
    register,
    handleSubmit,
    formState: { errors }
  } = useForm<CreateIngredientFormSchemaType>({
